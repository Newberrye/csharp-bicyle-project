...
internal class SampleReceipt
{
    ...
    private List<IBikeOptions> cartOptionsList;
    public SampleReceipt(List<IBicycle> bikeList, List<IBikeOptions> optionList)
    {
        cartList = bikeList;
    ...
    private void ShowCart()
    {
        ...
        if(cartOptionsList.Count > 0)
        {
            ...
            foreach (IBikeOptions option in cartOptionsList)
            {
                Console.WriteLine($"  {option.OptionType,9} {option.OptionPrice,14}");
            }
    ...
    private void ShowTitle()
    {
        ...
        ShowDashes();
        Console.WriteLine($"{"MONEY RECEIPT",25}");
    }
